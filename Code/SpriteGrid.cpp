...
{
    size_t height = Engine::Get().GetVisualization()->GetVerticalTilesOnScreenCount();
    size_t width  = Engine::Get().GetVisualization()->GetHorizontalTilesOnScreenCount();
    width++; //siatka zapamietuje o jeden kafel wiecej
